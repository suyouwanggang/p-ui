...
let PTips = class PTips extends LitElement {
    constructor() {
        super(...arguments);
        this.show = null;
        this.tips = null;
...
], PTips.prototype, "show", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTips.prototype, "tips", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTips.prototype, "color", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTips.prototype, "type", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTips.prototype, "dir", void 0);
PTips = __decorate([
    customElement('p-tips')
], PTips);

let PICon = class PICon extends LitElement {
    constructor() {
        super();
        this.view = 1024;
        this.name = '';
        this.iconPath = './iconfont/icon.svg';
        this.path = '';
        this.size = -1;
        this.color = '';
    }
...
], PICon.prototype, "view", void 0);
__decorate([
    property({ type: String, reflect: true })
], PICon.prototype, "name", void 0);
__decorate([
    property({ type: String, reflect: false })
], PICon.prototype, "iconPath", void 0);
__decorate([
    property({ type: String, reflect: false })
], PICon.prototype, "path", void 0);
__decorate([
    property({ type: Number, reflect: false })
], PICon.prototype, "size", void 0);
__decorate([
    property({ type: String, reflect: false })
], PICon.prototype, "color", void 0);
PICon = __decorate([
...
const numberRegMap = new Map();
const numberReg = /([0-9]+)[\.0-9]*/;
const getNumberReg = function (scale) {
    if (scale == 0) {
        return numberReg;
    }
    else {
...
let PInput = class PInput extends LitElement {
    constructor() {
        super(...arguments);
        this.name = '';
        this.type = 'text';
...
__decorate([
    property({ type: String, reflect: false })
], PInput.prototype, "name", void 0);
__decorate([
    property({ type: String, reflect: true })
], PInput.prototype, "type", void 0);
__decorate([
    property({ type: String, reflect: false })
], PInput.prototype, "pattern", void 0);
__decorate([
    property({ type: String, reflect: false })
], PInput.prototype, "placeholder", void 0);
__decorate([
    property({ type: String, reflect: false })
], PInput.prototype, "value", void 0);
__decorate([
    property({ type: String, reflect: false })
], PInput.prototype, "leftIcon", void 0);
__decorate([
    property({ type: String, reflect: false })
], PInput.prototype, "rightIcon", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "block", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "readonly", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "search", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "clear", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "novalidate", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "required", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PInput.prototype, "invalid", void 0);
__decorate([
    property({ type: Number, reflect: false })
], PInput.prototype, "scale", void 0);
__decorate([
    property({ type: Object })
], PInput.prototype, "customValidity", void 0);
PInput = __decorate([
    customElement('p-input')
], PInput);

let PSwitch = class PSwitch extends LitElement {
    constructor() {
        super();
        this.disabled = false;
        this.value = '';
...
__decorate([
    property({ type: Boolean, reflect: true })
], PSwitch.prototype, "disabled", void 0);
__decorate([
    property({ type: String, reflect: true })
], PSwitch.prototype, "value", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PSwitch.prototype, "checked", void 0);
__decorate([
    property({ type: String, reflect: true })
], PSwitch.prototype, "name", void 0);
PSwitch = __decorate([
    customElement('p-switch')
], PSwitch);

let PTab = class PTab extends LitElement {
    constructor() {
        super(...arguments);
    ...
    firstUpdated() {
        const slots = this.shadowRoot.getElementById('slots');
        slots.addEventListener('slotchange', (event) => {
            this.requestUpdate();
        });
    }
    _changeTabHanlder(event) {
    ...
    dispatchChangeEvent(tabContent) {
        if (tabContent == null || tabContent.disabled) {
            return;
        }
...
__decorate([
    property({ type: String, reflect: true })
], PTab.prototype, "tabPosition", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTab.prototype, "activeKey", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTab.prototype, "tabAgile", void 0);
PTab = __decorate([
    customElement('p-tab')
], PTab);
let PTabContent = class PTabContent extends LitElement {
    constructor() {
        super(...arguments);
        this.label = '';
        this.key = null;
...
__decorate([
    property({ type: String, reflect: true }),
    property({ type: String, reflect: true })
], PTabContent.prototype, "label", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTabContent.prototype, "key", void 0);
__decorate([
    property({ type: String, reflect: true })
], PTabContent.prototype, "icon", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], PTabContent.prototype, "disabled", void 0);
PTabContent = __decorate([
