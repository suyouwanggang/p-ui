...
@customElement('p-color-pane')
export default class PColorPane extends LitElement {
    ...
    render() {
        ...
        <div class="color-footer" data-type="${PColorPane.COLOR_TYPE[this.typeindex]}">
            ...
            <p-button class="btn-switch" id="btn-switch" @click=${this._switch_Hander} type="flat">${PColorPane.COLOR_TYPE[this.typeindex]}</p-button>
        </div>
